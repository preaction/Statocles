...
define its configuration. The format is L<http://yaml.org|YAML> and contains
...
places, a build directory, a staging area, an a deploy directory, the final
...
the root directory of our site. This is good for GitHub Pages site.
...
Combine it all together and you get. Feel free to copy and paste to start your
own site.
...
updated pages to the git repository. Then we just need to do a C<git push>
to make our changes live on GitHub Pages.

I<NOTE:> In the future, C<deploy> may perform C<push> automatically.
