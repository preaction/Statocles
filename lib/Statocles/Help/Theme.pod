...
=head1 Minor Theme Adjustments

If you only want to edit some minor things, such as the stylesheets, but want to get
any new fixes from the default theme you bundled, you can safely edit any of the
default includes, which start out as completely empty files.

If you have edited the default includes, the C<bundle theme> command will not update
them.

Some examples of files you can safely edit are:

=over 4

=item site/head_after.html

This include is after all the default C<E<lt>headE<gt>> content. You can add
links to new scripts and stylesheets here.

=item site/header_after.html

This include is after the nav bar and page header. You can add banners and such
here.

=item site/footer.html

The entire site footer is up to you to edit.

=item site/sidebar_before.html
